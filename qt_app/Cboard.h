...
public:
	...
	int search_width1, search_width2;
	...
	ll turn_lim , TURN_LIM ;
	ll t_count , MATCH_LIM;
	ll tend_stree;
	ll tend_VCTA;
	ll tend_VCTD;
	ll tend_VCT;
	...
	int start_depth1, end_depth1;
	int start_depth2, end_depth2 ,base_depth2;
	int start_depth3, end_depth3;
	...
	int MiniMax(int depth,int ide);
	int NegaScout(int depth,int ide,int alpha,int beta);
	int MTDf(int depth,int ide,int fval,int des);
